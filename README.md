...
svviz2 requires **python 3.3** or greater. A few more notable changes with respect to version 1.x:

- there is no multiprocessing support; you're probably best off parallelizing over events
